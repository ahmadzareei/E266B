// Sample code of Out-of-place 1-D real to complex fast fourier transformation.
...
//  physicall space!
// output files: sin.dat : y=sin(x) on [0,2PI]
//               cos.dat : y=cos(x) on [0,2PI], achieved by FFT
