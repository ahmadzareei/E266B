...
void CrankNicolsonDiffusion2D(fftw_complex * in, fftw_complex * out, const int Nx, const int Ny,\
			      ...
			      double * Kx, double * Ky, fftw_plan fft_forward_r2c, fftw_plan fft_backward_c2r);
...
int main(){
  ...
  CrankNicolsonDiffusion2D(fft_input_data,fft_input_data,Nx,Ny,dt,T,nux,nuy,Kx,Ky,fft_forward_r2c,fft_backward_c2r);
